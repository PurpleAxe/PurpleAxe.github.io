...
/* harmony import */ var _helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./helpers-5eb6364d.js */ 9364);
...
const iosEnterAnimation = (baseEl, position) => {
  ...
  const root = (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_8__.g)(baseEl);
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidDismiss", 7);
    ...
    this.duration = _ionic_global_3b28a225_js__WEBPACK_IMPORTED_MODULE_2__.c.getNumber('toastDuration', 0);
  ...
  present() {
    ...
    return (0,D_andy_Music_yoyo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.currentTransition = (0,_overlays_166b34ae_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, _this.position);
      yield _this.currentTransition;
  ...
  dismiss(data, role) {
    ...
    return (0,D_andy_Music_yoyo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.currentTransition = (0,_overlays_166b34ae_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, _this2.position);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_166b34ae_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_166b34ae_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  callButtonHandler(button) {
    return (0,D_andy_Music_yoyo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_166b34ae_js__WEBPACK_IMPORTED_MODULE_5__.s)(button.handler);
          if (rtn === false) {
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }), b.text), mode === 'md' && (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    if (layout === 'stacked' && startButtons.length > 0 && endButtons.length > 0) {
      (0,_index_e86f0117_js__WEBPACK_IMPORTED_MODULE_4__.p)('This toast is using start and end buttons with the stacked toast layout. We recommend following the best practice of using either start or end buttons with the stacked toast layout.', el);
    }
    return (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      class: "toast-icon",
      part: "icon",
      icon: this.icon,
      lazy: false,
      ...
      class: "toast-content"
    }, this.header !== undefined && (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "toast-header",
      part: "header"
