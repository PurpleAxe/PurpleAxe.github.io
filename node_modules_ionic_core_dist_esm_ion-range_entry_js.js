...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionKnobMoveStart = (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionKnobMoveEnd", 7);
    ...
    this.clampBounds = value => {
      return (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.l)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,D_andy_Music_yoyo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, this.ratioB + step, 1);
      }
  ...
  connectedCallback() {
    ...
    this.contentEl = (0,_index_455f6202_js__WEBPACK_IMPORTED_MODULE_3__.f)(this.el);
  }
  ...
  onStart(detail) {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_455f6202_js__WEBPACK_IMPORTED_MODULE_3__.d)(contentEl);
    }
    const rect = this.rect = this.rangeSlider.getBoundingClientRect();
    const currentX = detail.currentX;
    // figure out which knob they started closer to
    let ratio = (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, (currentX - rect.left) / rect.width, 1);
  ...
  onEnd(detail) {
    ...
    if (contentEl) {
      (0,_index_455f6202_js__WEBPACK_IMPORTED_MODULE_3__.r)(contentEl, initialContentScrollY);
    }
    this.update(detail.currentX);
    this.pressedKnob = undefined;
    this.emitValueChange();
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new range syntax.`, this.el);
    ...
    (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.d)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    return (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      name: "start"
    }), this.renderRangeSlider(), (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "end"
    }));
  }
  renderRange() {
  ...
  renderRangeSlider() {
    ...
    let {
      labelText
    } = (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.e)(el, rangeId);
    ...
    }, ticks.map(tick => (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  return (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.l)(min, value, max);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_5__.l)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
  ios: rangeIosCss,
