...
const PickerInternal = class {
  constructor(hostRef) {
    ...
    this.ionInputModeChange = (0,_index_be218d70_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionInputModeChange", 7);
  ...
  componentWillLoad() {
    (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_5eb6364d_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  /**
   * @internal
